...
class SimplerOdorCNN(nn.Module):
    """
    Simpler CNN architecture for odor classification.
    ...
    def __init__(
        ...
        """
        Initialize the simpler CNN model.
        ...
        Args:
            ...
            input_size: Input image size (assuming square images)
        """
        super(SimplerOdorCNN, self).__init__()
...
def create_model(config: dict) -> nn.Module:
    """
    Model factory function to create models based on configuration.
    ...
    elif model_name.lower() == 'simpleodorcnn':
        return SimplerOdorCNN(
            num_classes=num_classes,
            input_channels=model_config.get('input_channels', 1),
            dropout_rate=model_config.get('dropout_rate', 0.3),
            input_size=model_config.get('input_size', 256)
